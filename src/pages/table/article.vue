    ...
    <div class="panel-body">
      ...
      <el-table
        ...
        <el-table-column
          ...
          >
          <template scope="props">
            <el-button type="info" size="small" icon="edit"  prop="template" v-if="props.row.templateId" @click="deltemplate(props.row.id,props.$index)">
	            <span>取消模板</span>
	          </el-button>
      ...
      <el-dialog title="" :visible.sync="dialogTableVisible">
	      ...
	      <div slot="footer" class="dialog-footer">
	        ...
	        <el-button type="primary" @click="(temp.id)">确 定</el-button>
	      </div>
	    </el-dialog>
      <bottom-tool-bar>
        <!--<el-button
